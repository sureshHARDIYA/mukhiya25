...
try {
  ...
  if (esbuildPackage) {
    ...
    console.log('⚠️ Unknown platform, skipping platform-specific esbuild installation');
  }
} catch (error) {
  console.warn('⚠️ Failed to install platform-specific esbuild binary:', error.message);
